...
import BottomSheet1 from './components/Option2/index'
import GoalSheet from './components/Option2/GoalSheet'
...
export default function App() {
  ...
  return (
    <SafeAreaProvider>
      ...
      <GoalSheet ref={goalSheetRef} onExpand={onGoalSheetOpen} />
